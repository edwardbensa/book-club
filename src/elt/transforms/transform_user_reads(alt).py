...
from src.elt.transforms.utils import connect_mongodb, get_id_mappings, get_name_mappings
...
def parse_rstatus_history(history_string):
    ...
    for entry in entries:
        ...
        if match:
            ...
            history_list.append({
                "rstatus_name": name_mappings['read_statuses'].get(status_id),
    ...
    for user_read in user_reads_data:
        try:
            ...
            transformed_doc = {
                ...
                "current_rstatus_name": name_mappings["read_statuses"].get(user_read.get("current_rstatus_id")),
